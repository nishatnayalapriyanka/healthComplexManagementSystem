...
public class LogInPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblBangladeshHealthComplexMsg, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 60, 600, 100));

        lblUseIdLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/healthComplex/user id logo.png"))); // NOI18N
        getContentPane().add(lblUseIdLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 290, 60, 50));
        ...
        getContentPane().add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 360, 200, 50));

        lblPasswordLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/healthComplex/password logo.png"))); // NOI18N
        getContentPane().add(lblPasswordLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 360, 60, 50));
        ...
        getContentPane().add(lblBlindLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 360, 50, 50));
        ...
        getContentPane().add(lblEyeLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 360, 50, 50));

        btLogIn.setFont(new java.awt.Font("Times New Roman", 3, 24)); // NOI18N
        ...
        getContentPane().add(btLogIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 440, 170, 50));
        ...
        getContentPane().add(btReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 510, 170, 50));
        ...
        getContentPane().add(lblUserID, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 290, 200, 50));
        ...
        getContentPane().add(btBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 440, 170, 50));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 360, 300, 50));
    ...
    private void btLogInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLogInActionPerformed
        if(txtUserID.getText().isEmpty()||txtPassword.getText().isEmpty()){
            JOptionPane.showMessageDialog(this,"Enter User ID and  Password...","Warning",JOptionPane.WARNING_MESSAGE);
        }
        else if(txtUserID.getText().equals("Bangladesh")&&txtPassword.getText().equals("SJPCNP123")){
            JOptionPane.showMessageDialog(this,"Log in successfully..."," ",JOptionPane.INFORMATION_MESSAGE);
            setVisible(false);
            MenuPage m = new MenuPage();
            m.setVisible(true);
        }
        else{
            JOptionPane.showMessageDialog(this,"Incorrect User ID or  Password , Try again...","Error",JOptionPane.ERROR_MESSAGE);
            txtUserID.setText("  ");
